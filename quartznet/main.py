...
sys.path.insert(0, '/opt/intel/openvino_2021/deployment_tools/open_model_zoo/demos/speech_recognition_quartznet_demo/python/')
from speech_recognition_quartznet_demo_mod import main
try:
 for data, event in ippe.data_and_event_generator():
  if event == 'pcm':
   print('received from audio ingestion..')
   f = wave.open('/home/sys-admin/recorded.wav', 'wb')
   ...
   f.close()
   data = None
   transcript = main("/Models/quartznet-15x5-en.xml", "/home/sys-admin/recorded.wav")
